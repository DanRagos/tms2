	...
	if(isset($_POST['moa_set'])) {	
		...
		$queryun= "select * from file WHERE name='$file_name'";
			...
			$row = $conn->query("SELECT * FROM `file` where name='$file_name'") or die(mysqli_error());
				...
				$sql2= "INSERT INTO `memorandum_agreement` (id, file_id, file_name , effective_date, parties_involve, description) values (NULL, '$file_name1', '$file_name', '$eff_date', '$part_agency', '$description')";
