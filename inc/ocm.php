<?php
 ...
 if ($_SESSION['type']!="admin") {
			...
			$sql2= "INSERT INTO `outgoing_comm`(id, file_id, file_name, agency, purpose, phase, date) values (NULL, '$file_name1', '$file_name',  '$receive_agen', '$purpose', '$phase', '$inc_date')";
